...
// User message for RPC responses (minimal fields for transport). id is UUID string after 002 migration.
type UserMsg struct {
...
// AuthLog for LogAuth. user_id is UUID string when present.
...
func (x *AuthLogMsg) GetUserId() string {
...
func (x *RequestPhoneChangeRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *ConfirmPhoneChangeRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *GetUserResponse) GetUser() *UserMsg {
	if x != nil {
		return x.User
	}
	return nil
...
const file_auth_service_proto_rawDesc = "" +
	...
	"\x04user\x18\x01 \x01(\v2\x10.auth.v1.UserMsgR\x04user\x121\n" +
	"\x05error\x18\x02 \x01(\v2\x16.auth.v1.ErrorResponseH\x00R\x05error\x88\x01\x01B\b\n" +
	"\x06_errorB0Z.github.com/your-moon/grape-shared/proto/authv1b\x06proto3"
...
var file_auth_service_proto_goTypes = []any{
	...
	(*GetUserRequest)(nil),            // 23: auth.v1.GetUserRequest
	(*GetUserResponse)(nil),           // 24: auth.v1.GetUserResponse
}
var file_auth_service_proto_depIdxs = []int32{
	...
	0, // 4: auth.v1.GetUserResponse.user:type_name -> auth.v1.UserMsg
	6, // 5: auth.v1.GetUserResponse.error:type_name -> auth.v1.ErrorResponse
...
func file_auth_service_proto_init() {
	...
	file_auth_service_proto_msgTypes[24].OneofWrappers = []any{}
	type x struct{}
